topojson = function() {
    ...
    function o(e, n) {
        function t(e, n) {
            n.length && n.pop();
            for (var t, r = f[0 > e ? ~e: e], o = 0, i = r.length; i > o; ++o) n.push(t = r[o].slice()),
            s(t, o);
            0 > e && a(n, i)
        }
        function r(e) {
    ...
    function a(e, n) {
        for (var t, r = e.length, o = r - n; o < --r;) t = e[o],
        e[o++] = e[r],
        e[r] = t
    }
    function i(e, n) {
    ...
    function u(e) {
        ...
        for (var c in o) for (var s = o[c], f = s.length, l = 0; f > l; ++l) for (var d = l + 1; f > d; ++d) {
            var p,
            v = s[l],
            h = s[d]; (p = a[v])[c = i(p, h)] !== h && p.splice(c, 0, h),
    ...
    function c(e, n) {
        ...
        for (n || (n = s), e.arcs.forEach(function(e) {
            var t = [];
            e.forEach(o);
            for (var a = 1, u = e.length - 1; u > a; ++a) r = e.slice(a - 1, a + 2),
            r[1][2] = n(r),
            t.push(r),
            i.push(r);
            e[0][2] = e[u][2] = 1 / 0;
            for (var a = 0, u = t.length; u > a; ++a) r = t[a],
            r.previous = t[a - 1],
            r.next = t[a + 1]
        }); r = i.pop();) {
            var c = r.previous,
    ...
    function l(e) {
        ...
        r.pop = function() {
            var e = o[0],
            n = o.pop();
            return o.length && (o[n.index = 0] = n, t(0)),
            e
        },
        r.remove = function(r) {
            var a = r.index,
            i = o.pop();
            return a !== o.length && (o[i.index = a] = i, (e(i, r) < 0 ? n: t)(a)),
            a
        },
        r
    }
